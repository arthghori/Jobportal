<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Terms_condition.aspx.cs" Inherits="job_portal.common.Terms_condition" %>
...
<body>
    <form id="Terms_condition" runat="server"  style="height:100%;width:100%;">
        <!-- Header -->
        ...
        <pre style="color:#059669;padding:10px;font-size:18px;background-color:#0596690D;width:100%">
            
                <pre style="font-size:40px;font-weight: bolder; font-family: Arial, Helvetica, sans-serif;">AGREEMENT TO TERMS</pre>
