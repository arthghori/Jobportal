...
<body>
    ...
    <ul class="nav nav-tabs" style="font-weight: bold; background-color: #FFFFFF; display: flex; align-items: center; padding: 10px;">
     ...
     <a class="nav-link" href="/company_main.aspx" style="color: #059669;">Home</a>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" href="postedjob_list.aspx" id="jobsDropdown">Jobs</a>
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="/postedjob_list.aspx">Posted jobs</a></li>
                       ...
                       <li class="nav-item">
    <a class="nav-link" href="Contact_us.aspx" style="color: #059669;">Contact us</a>
</li>
    ...
    <div class="cards-container">
         ...
         <a href="job_post.aspx" style="text-decoration:none;"> <img src="Images/Static/mp6swi3s.png" alt="Announce Job" /></a>
             <div class="p-3">
             <a href="job_post.aspx" style="text-decoration:none; color:black;">    <h5>Announce a job vacancy</h5>   </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             </div>
         </div>
         <div class="auto-style2">
             <a href="postedjob_list.aspx" style="text-decoration:none;"> <img src="Images/Static/a1w0voch.png" alt="Vacancies" /> </a>
             <div class="p-3">
            <a href="postedjob_list.aspx" style="text-decoration:none; color:black;"> <h5>Vacancies announced</h5></a>
 </div>
         </div>
     </div>
