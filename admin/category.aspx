<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category.aspx.cs" Inherits="job_portal.admin.category" %>
...
<body>
    <form id="Categorylist" runat="server">
    ...
    <ul class="dropdown-menu">
        ...
        <div class="container">
            ...
            <h2>Category Management List</h2>
            
            <div class="input-container">
                <asp:TextBox ID="txtCategoryName" runat="server" CssClass="auto-style1" Placeholder="Enter Category Name" Width="400px"></asp:TextBox>
                <asp:Button ID="btnAddCategory" runat="server" CssClass="btn" Text="Add Category" OnClick="btnAddCategory_Click" Style="background-color: #059669" />
            </div>

            <asp:GridView ID="gvCategories" runat="server" AutoGenerateColumns="False" CssClass="table" 
                OnRowDeleting="gvCategories_RowDeleting" DataKeyNames="CategoryID">
                <Columns>
